...
//
// thirdparty/antlr/include/antlr3commontoken.h
//
...
// <06A52F29> ../thirdparty/antlr/include/antlr3commontoken.h:107
// member functions: 19
// member variables: 36
// struct size: 264
struct ANTLR3_COMMON_TOKEN_struct {
	/* ../thirdparty/antlr/include/antlr3commontoken.h:173 */
	union {
...
// <002793C4> ../../thirdparty/antlr/include/antlr3commontoken.h:107
// member functions: 19
// member variables: 36
// struct size: 264
struct ANTLR3_COMMON_TOKEN_struct {
...
// <06A52E82> ../thirdparty/antlr/include/antlr3commontoken.h:314
// member functions: 3
// member variables: 8
// struct size: 312
struct ANTLR3_TOKEN_FACTORY_struct {
	pANTLR3_COMMON_TOKEN * pools; /* 0 8 */
	ANTLR3_INT32 thisPool; /* 8 4 */
	ANTLR3_UINT32 nextToken; /* 12 4 */
	ANTLR3_COMMON_TOKEN unTruc; /* 16 264 */
	pANTLR3_INPUT_STREAM input; /* 280 8 */
	pANTLR3_COMMON_TOKEN (*newToken)(ANTLR3_TOKEN_FACTORY_struct* ); /* 288 8* /
	void (*setInputStream)(ANTLR3_TOKEN_FACTORY_struct* , pANTLR3_INPUT_STREAM); /* 296 8* /
	void (*close)(ANTLR3_TOKEN_FACTORY_struct* ); /* 304 8* /
};
